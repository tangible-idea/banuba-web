...
export const categoriesButtonLeft = document.querySelector(".categories-button__left");
export const categoriesButtonRight = document.querySelector(".categories-button__right");
export const handGesturesBlock = document.querySelector(".hand-gestures");
export const handGesturesTipBlock = document.querySelector(".hand-gestures-tip");
